...
/**
 * The maximum size of a log message prior to SDL2 2.0.24
 *
 * As of 2.0.24 there is no limit to the length of SDL2 log messages.
 */
 ...
 *
 * This function is called by SDL2 when there is new text to be logged.
 *
