 ...
 *
 * On some platforms SDL2 first sees the touch device if it was actually used.
 ...
 * correct.
 *
 * This was fixed for Android in SDL2 2.0.1.
 *
 ...
 *
 * The returned resource is owned by SDL2 and should not be deallocated.
 *
