 ...
 *
 * SDL2 will make system changes as necessary in order to apply the thread
 ...
 *
 * SDL2 makes an attempt to report `name` to the system, so that debuggers can
 ...
 *
 * If a system imposes requirements, SDL2 will try to munge the string for it
 ...
 *
 * In SDL2 2.1, stack size will be folded into the original SDL_CreateThread
 ...
 * If SDL2 is running on a platform that does not support threads the return
