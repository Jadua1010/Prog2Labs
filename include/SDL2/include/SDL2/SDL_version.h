...
/**
 * Information about the version of SDL2 in use.
 *
...
/**
 * Macro to determine SDL2 version program was compiled against.
 *
...
/* TODO: Remove this whole block in SDL2 3 */
 ...
 * be encoded as 25799.
 *
 * This macro will not be available in SDL2 3.x.
 */
...
/**
 * Get the version of SDL2 that is linked against your program.
 *
 * If you are linking to SDL2 dynamically, then it is possible that the current
...
/**
 * Get the code revision of SDL2 that is linked against your program.
 *
 ...
 *
 * If SDL2 wasn't built from a git repository with the appropriate tools, this
 * will return an empty string.
 *
 * Prior to SDL2 2.0.16, before development moved to GitHub, this returned a
 ...
 *
 * When SDL2 was hosted in a Mercurial repository, and was built carefully,
 * this would return the revision number that the build was created from. This
 * number was not reliable for several reasons, but more importantly, SDL2 is
 * now hosted in a git repository, which does not offer numbers at all, only
 * hashes. This function only ever returns zero now. Don't use it.
 *
 * Before SDL2 2.0.16, this might have returned an unreliable, but non-zero
 * number.
 *
 * \deprecated Use SDL_GetRevision() instead; if SDL2 was carefully built, it
 *             will return a git hash.
 *
 * \returns zero, always, in modern SDL2 releases.
 *
 * \since This function is available since SDL2 2.0.0.
 *
 * \sa SDL_GetRevision
