 ...
 * above must be known before SDL2 creates the window that will be used with
...
typedef enum SDL_GLattr
{
    ...
    SDL_GL_FRAMEBUFFER_SRGB_CAPABLE,    /**< requests sRGB capable visual; defaults to 0. (>= SDL2 2.0.1) */
    SDL_GL_CONTEXT_RELEASE_BEHAVIOR,    /**< sets context the release behavior; defaults to 1. (>= SDL2 2.0.4) */
...
/**
 * Get the number of video drivers compiled into SDL2.
 *
 ...
 *
 * \since This function is available since SDL2 2.0.9.
 *
 * \sa SDL_GetNumVideoDisplays
 */
 ...
 * when SDL2 runs fullscreen and has changed the resolution. In that case this
 ...
 *
 * On non-Apple devices, SDL2 requires you to either not link to the Vulkan
 * loader or link to a dynamic library version. This limitation may be removed
 * in a future version of SDL2.
 *
...
/**
 * Create an SDL2 window from an existing native window.
 *
 ...
 * chance to decorate the window and provide the border dimensions to SDL2.
 *
 ...
 *          SDL_FALSE otherwise.
 *
 * \since This function is available since SDL2 2.28.0.
 *
...
/**
 * Get the SDL2 surface associated with the window.
 *
 ...
 * screen.
 *
 * This function is equivalent to the SDL2 1.2 API SDL_Flip().
 *
 ...
 * on the screen.
 *
 * This function is equivalent to the SDL2 1.2 API SDL_UpdateRects().
 *
 * Note that this function will update _at least_ the rectangles specified,
 * but this is only intended as an optimization; in practice, this might
 * update more of the screen (or all of the screen!), depending on what method
 * SDL2 uses to send pixels to the system.
 *
 * \param window the window to update.
 ...
 *
 * When keyboard grab is enabled, SDL2 will continue to handle Alt+Tab when the
 ...
 * the SDL2 error message to "Invalid window". See SDL_GetError().
 *
 ...
 *
 * The screensaver is disabled by default since SDL2 2.0.2. Before SDL2 2.0.2
 ...
 *
 * If you disable the screensaver, it is automatically re-enabled when SDL2
 * quits.
 *
 * The screensaver is disabled by default since SDL2 2.0.2. Before SDL2 2.0.2
 * the screensaver was enabled by default.
 ...
 *
 * \since This function is available since SDL2 2.0.2.
 *
