 ...
 * string is larger than this, SDL2 will split it and send it in pieces, across
 * multiple events. The string is in UTF-8 format, and if split, SDL2
 ...
 *
 * SDL2 will send JOYSTICK_ADDED events for devices that are already plugged in
 * during SDL_Init.
 *
 ...
 *
 * SDL2 will send CONTROLLERDEVICEADDED events for joysticks that are already
 ...
 *
 * The SDL_Event structure is the core of all event handling in SDL2. SDL_Event
 * is a union of all event structures used in SDL2.
 */
 ...
 * this event, immediately stored in the SDL2 Event structure -- not an event
 * to follow.
 *
