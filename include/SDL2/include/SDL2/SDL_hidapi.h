 ...
 * # CategoryHIDAPI
 *
 * Header file for SDL2 HIDAPI functions.
 *
 ...
 * ```
 *
 * (Note that this license is the same as item three of SDL2's zlib license, so
 * it adds no new requirements on the user.)
 *
 * If you would like a version of SDL2 without this code, you can build SDL2
