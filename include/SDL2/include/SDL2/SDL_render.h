 ...
 * should use SDL2's OpenGL/Direct3D support or one of the many good 3D
 * engines.
 *
 ...
 *
 * There may be none if SDL2 was compiled without render support.
 *
 ...
 *          more information.
 *
 * \since This function is available since SDL2 2.0.22.
 */
 ...
 *
 * \since This function is available since SDL2 2.0.12.
 *
 ...
 * \returns 0 on success, or -1 if the texture is not valid.
 *
 * \since This function is available since SDL2 2.0.18.
 *
 ...
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL2 2.0.1.
 *
 * \sa SDL_UpdateTexture
 */
 ...
 * \param surface this is filled in with an SDL2 surface representing the
 *                locked area.
 ...
 *
 * \since This function is available since SDL2 2.0.10.
 */
 ...
 *
 * \param renderer The rendering context.
 * \param texture (optional) The SDL2 texture to use.
 ...
 *
 * SDL2's rendering functions operate on a backbuffer; that is, calling a
 * rendering function such as SDL_RenderDrawLine() does not directly put a
 * line on the screen, but rather updates the backbuffer. As such, you compose
 * your entire scene and *present* the composed backbuffer to the screen as a
 * complete picture.
 *
 * Therefore, when using SDL2's rendering API, one does all drawing intended
 ...
 *
 * Passing NULL or an otherwise invalid texture will set the SDL2 error message
 * to "Invalid texture".
 *
 ...
 * the SDL2 error message to "Invalid renderer". See SDL_GetError().
 *
 * \param renderer the rendering context.
 *
 * \since This function is available since SDL2 2.0.0.
 ...
 *
 * This is for a very-specific case: if you are using SDL2's render API, you
 * asked for a specific renderer backend (OpenGL, Direct3D, etc), you set
 * SDL_HINT_RENDER_BATCHING to "1", and you plan to make OpenGL/D3D/whatever
 * calls in addition to SDL2 render API calls. If all of this applies, you
 * should call SDL_RenderFlush() between calls to SDL2's render API and the
 * low-level API you're using in cooperation.
 *
 * In all other cases, you can ignore this function. This is only here to get
 * maximum performance out of a specific situation. In all other cases, SDL2
 * will do the right thing, perhaps at a performance loss.
 *
 * This function is first available in SDL2 2.0.10, and is not needed in 2.0.9
 ...
 *
 * Also note that SDL2 may upload RGB textures as BGR (or vice-versa), and
 ...
 *
 * This function returns `void *`, so SDL2 doesn't have to include Metal's
 ...
 *          Metal renderer.
 *
 * \since This function is available since SDL2 2.0.8.
 *
 ...
 *
 * Note that as of SDL2 2.0.18, this will return NULL if Metal refuses to give
 * SDL2 a drawable to render to, which might happen if the window is
