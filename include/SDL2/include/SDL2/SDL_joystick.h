 ...
 *
 * As of SDL2 2.26.0, you can take the joystick lock around reinitializing the
 * joystick subsystem, to prevent other threads from seeing joysticks in an
 * uninitialized state. However, all open joysticks will be closed and SDL2
 ...
 *
 * \since This function is available since SDL2 2.0.6.
 */
 ...
 * recognized by SDL2 on the system. It is **NOT** the same as the instance ID
 ...
 * indirectly through various other SDL2 APIs, including, but not limited to
 ...
 *
 * **WARNING**: Calling this function may delete all events currently in SDL2's
 * event queue.
 *
 ...
 *
 * If SDL2 was built with events disabled (extremely uncommon!), this will do
 ...
 *
 * SDL2 makes no promises about what part of the joystick any given axis refers
 * to. Your game should have some sort of configuration UI to let users
 * specify what each axis should be bound to. Alternately, SDL2's higher-level
