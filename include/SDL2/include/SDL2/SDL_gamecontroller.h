...
/**
 * Load a set of Game Controller mappings from a seekable SDL2 data stream.
 *
 ...
 *
 * If this function is called before SDL_Init, SDL2 will generate an
...
/**
 * Add support for controllers that SDL2 is unaware of or to cause an existing
 ...
 *
 * \since This function is available since SDL2 2.30.0.
 */
...
/**
 * Get the SDL2 joystick layer binding for a controller axis mapping.
 *
 ...
 * that is all the information SDL2 has about the physical device.
 *
 * \param gamecontroller a game controller.
...
/**
 * Get the SDL2 joystick layer binding for a controller button mapping.
 *
 * \param gamecontroller a game controller.
 ...
 * as that is all the information SDL2 has about the physical device.
 *
 * \param gamecontroller a game controller.
