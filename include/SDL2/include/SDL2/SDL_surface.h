...
/**
 * Load a BMP image from a seekable SDL2 data stream.
 *
...
/**
 * Save a surface to a seekable SDL2 data stream in BMP format.
 *
 ...
 * ```
 *
 * You should call SDL_BlitSurface() unless you know exactly how SDL2 blitting
